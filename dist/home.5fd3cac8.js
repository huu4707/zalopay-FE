...
},{"isarray":"node_modules/qrcode/node_modules/isarray/index.js","buffer":"../../.config/yarn/global/node_modules/buffer/index.js"}],"node_modules/qrcode/lib/core/utils.js":[function(require,module,exports) {
var toSJISFunction;
...
},{"./can-promise":"node_modules/qrcode/lib/can-promise.js","./core/qrcode":"node_modules/qrcode/lib/core/qrcode.js","./renderer/canvas":"node_modules/qrcode/lib/renderer/canvas.js","./renderer/svg-tag.js":"node_modules/qrcode/lib/renderer/svg-tag.js"}],"js/common.js":[function(require,module,exports) {
"use strict";
...
},{"./common":"js/common.js"}],"js/home.js":[function(require,module,exports) {
"use strict";
...
var $loading = $('#loading');
var $web2appLink = $('#web2app-link');

_zalopay.ZaloPay.getbanklist(function (banklist) {
  banklist.forEach(function (bank) {
    $bankcode.append("\n      <option value=\"".concat(bank.bankcode, "\">").concat(bank.name, "</option>\n    "));
  });
});
...
function showQR(text) {
  ...
  _qrcode.default.toCanvas(qrCanvas, text);
}
...
$('#myForm').submit(function (e) {
  ...
  switch (activeTab) {
    case 'qr-tab':
      _zalopay.ZaloPay.qr(order, function (res) {
        showQR(res.orderurl);
        $web2appLink.attr('href', res.orderurl);

        _zalopay.ZaloPay.listenCallback(res.apptransid, hideQR);
      });
    ...
    case 'gateway-tab':
      ...
      _zalopay.ZaloPay.gateway(order);
    ...
    case 'quickpay-tab':
      if ($paymentCode.val().length === 0) {
        ...
        _zalopay.ZaloPay.quickPay(order, function (res) {
          showLoading();

          _zalopay.ZaloPay.listenCallback(res.apptransid, hideLoading);
        });
      }
...
},{"qrcode":"node_modules/qrcode/lib/browser.js","./zalopay":"js/zalopay.js"}],"../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/home.js"], null)
